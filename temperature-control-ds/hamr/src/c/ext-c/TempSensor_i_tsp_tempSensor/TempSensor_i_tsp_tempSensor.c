...
Unit b_TemperatureControl_TempSensor_i_tsp_tempSensor_initialise_(STACK_FRAME_ONLY) {
 DeclNewStackFrame(caller, "TempSensor_i_tsp_tempSensor.c", "", "b_TemperatureControl_TempSensor_i_tsp_tempSensor_initialise_", 0);
...
Unit b_TemperatureControl_TempSensor_i_tsp_tempSensor_finalise_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "TempSensor_i_tsp_tempSensor.c", "", "b_TemperatureControl_TempSensor_i_tsp_tempSensor_finalise_", 0);
