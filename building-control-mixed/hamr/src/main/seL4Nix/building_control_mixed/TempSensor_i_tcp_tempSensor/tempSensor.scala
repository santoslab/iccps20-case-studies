...
package building_control_mixed.TempSensor_i_tcp_tempSensor
...
import building_control_mixed.BuildingControl.TempSensor_i_tcp_tempSensor_seL4Nix

object tempSensor extends App {

  val tempSensorBridge : building_control_mixed.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge = {
