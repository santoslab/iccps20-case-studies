...
import art._
import pca_pump._
import pca_pump.PCA_Operation_Threads.{ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread => component}

// This file was auto-generated.  Do not edit

@record class ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : ICE_Thread_imp_Initialization_Api = {
    ...
    ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : ICE_Thread_imp_Operational_Api = {
    ...
    ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge.EntryPoints(
      id,
...
object ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge {
  ...
  @record class EntryPoints(
    ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_BridgeId)
