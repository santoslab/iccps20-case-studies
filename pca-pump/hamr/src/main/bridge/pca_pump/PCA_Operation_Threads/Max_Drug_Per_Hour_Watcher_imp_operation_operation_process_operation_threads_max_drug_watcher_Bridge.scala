...
import art._
import pca_pump._
import pca_pump.PCA_Operation_Threads.{Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher => component}

// This file was auto-generated.  Do not edit

@record class Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Max_Drug_Per_Hour_Watcher_imp_Initialization_Api = {
    ...
    Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Max_Drug_Per_Hour_Watcher_imp_Operational_Api = {
    ...
    Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_Bridge.EntryPoints(
      id,
...
object Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_Bridge {
  ...
  @record class EntryPoints(
    Max_Drug_Per_Hour_Watcher_imp_operation_operation_process_operation_threads_max_drug_watcher_BridgeId : Art.BridgeId,
