...
class isolette_single_sensor_Instance_operator_interface_oip_oit_Test extends BridgeTestSuite[operator_interface_thread_impl_Bridge](Arch.isolette_single_sensor_Instance_operator_interface_oip_oit) {
  ...
  def put_regulator_status(value : Isolette_Data_Model.Status.Type): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.regulator_status_Id, Isolette_Data_Model.Status_Payload(value))
  }

  // setter for in DataPort
  def put_monitor_status(value : Isolette_Data_Model.Status.Type): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.monitor_status_Id, Isolette_Data_Model.Status_Payload(value))
  }

  // setter for in DataPort
  def put_display_temperature(value : Isolette_Data_Model.Temp_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.display_temperature_Id, Isolette_Data_Model.Temp_impl_Payload(value))
  }

  // setter for in DataPort
  def put_alarm_control(value : Isolette_Data_Model.On_Off.Type): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.alarm_control_Id, Isolette_Data_Model.On_Off_Payload(value))
  }
  ...
  def get_lower_desired_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.lower_desired_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_impl_Payload]]
  }
  ...
  def get_upper_desired_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.upper_desired_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_impl_Payload]]
  }
  ...
  def get_lower_alarm_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.lower_alarm_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_impl_Payload]]
  }
  ...
  def get_upper_alarm_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.upper_alarm_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_impl_Payload]]
  }

  def getComponent(): operator_interface_thread_impl_Impl = {
    return bridge.entryPoints.asInstanceOf[operator_interface_thread_impl_Bridge.EntryPoints].component
  }
}
