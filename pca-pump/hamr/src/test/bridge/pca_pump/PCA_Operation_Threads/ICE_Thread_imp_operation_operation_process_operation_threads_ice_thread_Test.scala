...
class ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Test extends BridgeTestSuite[ICE_Thread_imp_operation_operation_process_operation_threads_ice_thread_Bridge](Arch.pca_imp_Instance_operation_operation_process_operation_threads_ice_thread) {
  ...
  def put_Infusion_Flow_Rate(value : PCA_Types.Flow_Rate): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.operational_api.Infusion_Flow_Rate_Id, PCA_Types.Flow_Rate_Payload(value))
  }
