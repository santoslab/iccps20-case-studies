...
Unit isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_heat_control_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Heat_Source_impl.c", "", "isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_heat_control_Send", 0);

  sb_heat_control_write(d);
}

// is_empty current_tempWstatus: In DataPort
B isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_current_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_current_tempWstatus_is_empty();
}

// receive current_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_current_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Heat_Source_impl.c", "", "isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_current_tempWstatus_Receive", 0);
...
B isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_lower_desired_temp_IsEmpty(STACK_FRAME_ONLY) {
  return sb_lower_desired_temp_is_empty();
}

// receive lower_desired_temp: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_lower_desired_temp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Heat_Source_impl.c", "", "isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_lower_desired_temp_Receive", 0);
...
B isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_upper_desired_temp_IsEmpty(STACK_FRAME_ONLY) {
  return sb_upper_desired_temp_is_empty();
}

// receive upper_desired_temp: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_upper_desired_temp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Heat_Source_impl.c", "", "isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_upper_desired_temp_Receive", 0);
...
B isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_regulator_mode_IsEmpty(STACK_FRAME_ONLY) {
  return sb_regulator_mode_is_empty();
}

// receive regulator_mode: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_regulator_mode_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Heat_Source_impl.c", "", "isolette_Regulate_Manage_Heat_Source_impl_seL4Nix_regulator_mode_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of Manage_Heat_Source_impl\n");
  ...
  isolette_Regulate_Manage_Heat_Source_impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  isolette_Regulate_Manage_Heat_Source_impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of Manage_Heat_Source_impl\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    isolette_Regulate_Manage_Heat_Source_impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
