...
package b.TempSensor_i_p_tempSensor
...
import b._
import b.TemperatureControl.TempSensor_i_p_tempSensor_seL4Nix

object tempSensor extends App {

  val tempSensorBridge : b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge = {
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(currentTemp_port.nonEmpty) {
      TempSensor_i_p_tempSensor_seL4Nix.currentTemp_Send(currentTemp_port.get)
      currentTemp_port = noData
    }

    if(tempChanged_port.nonEmpty) {
      TempSensor_i_p_tempSensor_seL4Nix.tempChanged_Send(tempChanged_port.get)
  ...
  def touch(): Unit = {
    if(F) {
      ...
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_initialization_api.get.logInfo("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_initialization_api.get.logDebug("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_initialization_api.get.logError("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_operational_api.get.logInfo("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_operational_api.get.logDebug("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_operational_api.get.logError("")
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_initialization_api.get.setcurrentTemp(TemperatureControl.Temperature_i.empty())
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_operational_api.get.setcurrentTemp(TemperatureControl.Temperature_i.empty())
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_initialization_api.get.sendtempChanged()
      b.TemperatureControl.TempSensor_i_p_tempSensor_Bridge.c_operational_api.get.sendtempChanged()
    }
  }
