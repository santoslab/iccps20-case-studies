...
class isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_mode_mrmt_Test extends BridgeTestSuite[Manage_Regulator_Mode_impl_Bridge](Arch.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_mode_mrmt) {
  ...
  def get_regulator_mode_payload(): Option[Isolette_Data_Model.Regulator_Mode_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.regulator_mode_Id).asInstanceOf[Option[Isolette_Data_Model.Regulator_Mode_Payload]]
  }

  def getComponent(): Manage_Regulator_Mode_impl_Impl = {
    return bridge.entryPoints.asInstanceOf[Manage_Regulator_Mode_impl_Bridge.EntryPoints].component
  }
}
