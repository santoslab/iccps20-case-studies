...
package isolette.isolette_single_sensor_Instance_heat_source_cpi_heat_controller
...
import isolette._
import isolette.Devices.Heat_Source_impl_seL4Nix

object heat_controller extends App {

  val heat_controllerBridge : isolette.Devices.Heat_Source_impl_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    heat_control_port = Heat_Source_impl_seL4Nix.heat_control_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(heat_out_port.nonEmpty) {
      Heat_Source_impl_seL4Nix.heat_out_Send(heat_out_port.get)
