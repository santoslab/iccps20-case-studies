...
package isolette.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_mode_mrmt
...
import isolette._
import isolette.Regulate.Manage_Regulator_Mode_impl_seL4Nix

object mrmt extends App {

  val mrmtBridge : isolette.Regulate.Manage_Regulator_Mode_impl_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    current_tempWstatus_port = Manage_Regulator_Mode_impl_seL4Nix.current_tempWstatus_Receive()

    interface_failure_port = Manage_Regulator_Mode_impl_seL4Nix.interface_failure_Receive()

    internal_failure_port = Manage_Regulator_Mode_impl_seL4Nix.internal_failure_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(regulator_mode_port.nonEmpty) {
      Manage_Regulator_Mode_impl_seL4Nix.regulator_mode_Send(regulator_mode_port.get)
