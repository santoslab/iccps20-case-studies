...
import art._
import pca_pump._
import pca_pump.PCA_Operation_Threads.{Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller => component}

// This file was auto-generated.  Do not edit

@record class Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_Bridge(
  val id: Art.BridgeId,
  val name: String,
  val dispatchProtocol: DispatchPropertyProtocol,
  val dispatchTriggers: Option[ISZ[Art.PortId]],

  Infusion_Flow_Rate: Port[PCA_Types.Flow_Rate],
  ...
  CP_Bolus_Duration: Port[ICE_Types.Minute],
  ...
  val initialization_api : Rate_Controller_imp_Initialization_Api = {
    ...
    Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Rate_Controller_imp_Operational_Api = {
    ...
    Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_Bridge.EntryPoints(
      id,
...
object Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_Bridge {
  ...
  @record class EntryPoints(
    Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Rate_Controller_imp_operation_operation_process_operation_threads_rate_controller_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == Alarm_Id){
          ...
          val Some(ICE_Types.Minute_Payload(value)) = Art.getValue(CP_Bolus_Duration_Id)
