...
package b.TempControl_i_tcp_tempControl
...
import b._
import b.TemperatureControl.TempControl_i_tcp_tempControl_seL4Nix

object tempControl extends App {

  val tempControlBridge : b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logInfo("")
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logDebug("")
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logError("")
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logInfo("")
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logDebug("")
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logError("")
      val apiUsage_currentTemp: Option[TemperatureControl.Temperature_i] = b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getcurrentTemp()
      val apiUsage_fanAck: Option[TemperatureControl.FanAck.Type] = b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getfanAck()
      val apiUsage_setPoint: Option[TemperatureControl.SetPoint_i] = b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getsetPoint()
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.sendfanCmd(TemperatureControl.FanCmd.byOrdinal(0).get)
      b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.sendfanCmd(TemperatureControl.FanCmd.byOrdinal(0).get)
      val apiUsage_tempChanged: Option[art.Empty] = b.TemperatureControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.gettempChanged()
    }
  }
