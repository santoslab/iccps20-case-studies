...
Unit building_control_gen_mixed_BuildingControl_Fan_i_seL4Nix_fanAck_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Fan_i.c", "", "building_control_gen_mixed_BuildingControl_Fan_i_seL4Nix_fanAck_Send", 0);
...
Unit building_control_gen_mixed_BuildingControl_Fan_i_seL4Nix_fanCmd_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Fan_i.c", "", "building_control_gen_mixed_BuildingControl_Fan_i_seL4Nix_fanCmd_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of Fan_i\n");
  ...
  printf("Leaving pre-init of Fan_i\n");
}
