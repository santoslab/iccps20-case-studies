...
bool sb_tempChanged_is_empty() {
  return *sb_tempChanged_counter == sb_tempChanged_last_counter;
}
...
Unit building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_fanCmd_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_fanCmd_Send", 0);
...
Unit building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_currentTemp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_currentTemp_Receive", 0);
...
Unit building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_fanAck_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_fanAck_Receive", 0);
...
Unit building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_tempChanged_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_tempChanged_Receive", 0);
...
// FIXME: dummy implementation for unconnected incoming port
Unit building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_setPoint_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "building_control_gen_mixed_BuildingControl_TempControl_i_seL4Nix_setPoint_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of TempControl_i\n");
  ...
  printf("Leaving pre-init of TempControl_i\n");
}
