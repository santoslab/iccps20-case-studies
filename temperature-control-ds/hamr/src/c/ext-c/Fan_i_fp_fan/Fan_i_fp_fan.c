...
Unit b_TemperatureControl_Fan_i_fp_fan_initialise_(STACK_FRAME_ONLY) {
 DeclNewStackFrame(caller, "Fan_i_fp_fan.c", "", "b_TemperatureControl_Fan_i_fp_fan_initialise_", 0);
...
Unit b_TemperatureControl_Fan_i_fp_fan_handlefanCmd_(
  ...
  DeclNewStackFrame(caller, "Fan_i_fp_fan.c", "", "b_TemperatureControl_Fan_i_fp_fan_handlefanCmd_", 0);

  DeclNewString(_str1);
  String str = (String) &_str1;
  String__append(str, string("received fanCmd "));
  b_TemperatureControl_FanCmd_Type_string_(SF str, value);
  api_logInfo__b_TemperatureControl_Fan_i_fp_fan(SF str);

  // always return 'Ok'
  b_TemperatureControl_FanAck_Type ack =
    b_TemperatureControl_FanAck_Type_Ok;

  api_send_fanAck__b_TemperatureControl_Fan_i_fp_fan(SF ack);
...
Unit b_TemperatureControl_Fan_i_fp_fan_finalise_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "Fan_i_fp_fan.c", "", "b_TemperatureControl_Fan_i_fp_fan_finalise_", 0);
