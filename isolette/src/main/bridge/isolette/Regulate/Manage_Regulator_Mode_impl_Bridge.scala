...
@record class Manage_Regulator_Mode_impl_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val api : Manage_Regulator_Mode_impl_Bridge.Api =
    Manage_Regulator_Mode_impl_Bridge.Api(
      id,
  ...
  val entryPoints : Bridge.EntryPoints =
    Manage_Regulator_Mode_impl_Bridge.EntryPoints(
      id,
      ...
      Manage_Regulator_Mode_impl_Impl(api)
    )
}

object Manage_Regulator_Mode_impl_Bridge {
  ...
  @record class EntryPoints(
    Manage_Regulator_Mode_impl_BridgeId : Art.BridgeId,
    ...
    component : Manage_Regulator_Mode_impl_Impl ) extends Bridge.EntryPoints {
