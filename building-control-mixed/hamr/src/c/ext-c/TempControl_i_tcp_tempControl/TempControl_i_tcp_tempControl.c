...
Unit building_control_mixed_BuildingControl_TempControl_i_tcp_tempControl_handletempChanged_(STACK_FRAME_ONLY) {
  ...
  if(api_get_currentTemp__building_control_mixed_BuildingControl_TempControl_i_tcp_tempControl(SF &currentTemp)){
    struct building_control_mixed_BuildingControl_Temperature_i currentTempInF = convertTemperatureToFahrenheit(&currentTemp);
    ...
    if(currentTemp.degrees > setPoint.high.degrees) {
      api_send_fanCmd__building_control_mixed_BuildingControl_TempControl_i_tcp_tempControl(SF
        building_control_mixed_BuildingControl_FanCmd_Type_On);
