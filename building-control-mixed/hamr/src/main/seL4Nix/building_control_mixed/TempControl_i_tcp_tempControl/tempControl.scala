...
package building_control_mixed.TempControl_i_tcp_tempControl
...
import building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_seL4Nix

object tempControl extends App {

  val tempControlBridge : building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge = {
    ...
    building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge(
      id = 0,
  ...
  def touch(): Unit = {
    if(F) {
      ...
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logInfo("")
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logDebug("")
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.logError("")
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logInfo("")
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logDebug("")
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.logError("")
      val apiUsage_currentTemp: Option[BuildingControl.Temperature_i] = building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getcurrentTemp()
      val apiUsage_fanAck: Option[BuildingControl.FanAck.Type] = building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getfanAck()
      val apiUsage_setPoint: Option[BuildingControl.SetPoint_i] = building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.getsetPoint()
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_initialization_api.get.sendfanCmd(BuildingControl.FanCmd.byOrdinal(0).get)
      building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.sendfanCmd(BuildingControl.FanCmd.byOrdinal(0).get)
      val apiUsage_tempChanged: Option[art.Empty] = building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge.c_operational_api.get.gettempChanged()
    }
  }
