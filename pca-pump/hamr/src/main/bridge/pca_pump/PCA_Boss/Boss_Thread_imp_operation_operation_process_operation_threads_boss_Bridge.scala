...
import art._
import pca_pump._
import pca_pump.PCA_Boss.{Boss_Thread_imp_operation_operation_process_operation_threads_boss => component}

// This file was auto-generated.  Do not edit

@record class Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Boss_Thread_imp_Initialization_Api = {
    ...
    Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Boss_Thread_imp_Operational_Api = {
    ...
    Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge.EntryPoints(
      id,
...
object Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge {
  ...
  @record class EntryPoints(
    Boss_Thread_imp_operation_operation_process_operation_threads_boss_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Boss_Thread_imp_operation_operation_process_operation_threads_boss_BridgeId)
