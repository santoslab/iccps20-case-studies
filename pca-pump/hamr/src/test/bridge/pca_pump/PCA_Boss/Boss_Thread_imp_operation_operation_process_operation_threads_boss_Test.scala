...
class Boss_Thread_imp_operation_operation_process_operation_threads_boss_Test extends BridgeTestSuite[Boss_Thread_imp_operation_operation_process_operation_threads_boss_Bridge](Arch.pca_imp_Instance_operation_operation_process_operation_threads_boss) {
