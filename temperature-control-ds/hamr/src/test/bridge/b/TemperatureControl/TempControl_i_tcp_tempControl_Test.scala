...
class TempControl_i_tcp_tempControl_Test extends BridgeTestSuite[TempControl_i_tcp_tempControl_Bridge](Arch.TempControlSystem_i_Instance_tcp_tempControl) {
