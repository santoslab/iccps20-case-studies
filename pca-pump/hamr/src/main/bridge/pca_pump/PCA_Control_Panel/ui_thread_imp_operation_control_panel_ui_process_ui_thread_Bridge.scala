...
import art._
import pca_pump._
import pca_pump.PCA_Control_Panel.{ui_thread_imp_operation_control_panel_ui_process_ui_thread => component}

// This file was auto-generated.  Do not edit

@record class ui_thread_imp_operation_control_panel_ui_process_ui_thread_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  Bolus_Duration: Port[ICE_Types.Minute],
  ...
  val initialization_api : ui_thread_imp_Initialization_Api = {
    ...
    ui_thread_imp_operation_control_panel_ui_process_ui_thread_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : ui_thread_imp_Operational_Api = {
    ...
    ui_thread_imp_operation_control_panel_ui_process_ui_thread_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    ui_thread_imp_operation_control_panel_ui_process_ui_thread_Bridge.EntryPoints(
      id,
...
object ui_thread_imp_operation_control_panel_ui_process_ui_thread_Bridge {
  ...
  @record class EntryPoints(
    ui_thread_imp_operation_control_panel_ui_process_ui_thread_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(ui_thread_imp_operation_control_panel_ui_process_ui_thread_BridgeId)
