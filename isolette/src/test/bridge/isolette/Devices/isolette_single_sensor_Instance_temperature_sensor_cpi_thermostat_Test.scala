...
class isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_Test extends BridgeTestSuite[Temperature_Sensor_impl_Bridge](Arch.isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat) {
  ...
  def put_air(value : Isolette_Data_Model.PhysicalTemp_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.air_Id, Isolette_Data_Model.PhysicalTemp_impl_Payload(value))
  }
  ...
  def get_current_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.current_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_impl_Payload]]
  }

  def getComponent(): Temperature_Sensor_impl_Impl = {
    return bridge.entryPoints.asInstanceOf[Temperature_Sensor_impl_Bridge.EntryPoints].component
  }
}
