...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/slang_libraries/TempSensor_i_tcp_tempSensor"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/building_control_mixed/BuildingControl${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/building_control_mixed/TempSensor_i_tcp_tempSensor" \
  --output-dir "${OUTPUT_DIR}" \
  --name "TempSensor_i_tcp_tempSensor" \
  --apps "building_control_mixed.TempSensor_i_tcp_tempSensor.tempSensor" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 2 \
  ...
  --cmake-includes "+${SCRIPT_HOME}/settings_TempSensor_i_tcp_tempSensor.cmake" \
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --apps "building_control_mixed.TempControl_i_tcp_tempControl.tempControl" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 5 \
...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/slang_libraries/Fan_i_tcp_fan"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/building_control_mixed/BuildingControl${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/building_control_mixed/Fan_i_tcp_fan" \
  --output-dir "${OUTPUT_DIR}" \
  --name "Fan_i_tcp_fan" \
  --apps "building_control_mixed.Fan_i_tcp_fan.fan" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 2 \
  --sequence "MS[Z,art.Bridge]=1;MS[Z,MOption[art.Bridge]]=1;IS[Z,art.UPort]=2;IS[Z,art.UConnection]=1" \
  --constants "art.Art.maxComponents=1;art.Art.maxPorts=2" \
  --cmake-includes "+${SCRIPT_HOME}/settings_Fan_i_tcp_fan.cmake" \
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/building_control_mixed/SlangTypeLibrary" \
  --output-dir "${OUTPUT_DIR}" \
  --name "SlangTypeLibrary" \
  --apps "building_control_mixed.SlangTypeLibrary.SlangTypeLibrary" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  --cmake-includes "+${SCRIPT_HOME}/settings_SlangTypeLibrary.cmake" \
  --forward "art.ArtNative=building_control_mixed.SlangTypeLibrary.SlangTypeLibrary" \
  --stack-size "16777216" \
  --stable-type-id \
  --lib-only \
  --verbose