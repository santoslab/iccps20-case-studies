...
#include <operator_interface_thread_impl_adapter.h>
#include <string.h>
#include <camkes.h>
...
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_lower_desired_tempWstatus_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_lower_desired_tempWstatus_Send", 0);

  sb_lower_desired_tempWstatus_write(d);
}

// send upper_desired_tempWstatus: Out DataPort Isolette_Data_Model__TempWstatus_impl
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_upper_desired_tempWstatus_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_upper_desired_tempWstatus_Send", 0);

  sb_upper_desired_tempWstatus_write(d);
}

// send upper_alarm_tempWstatus: Out DataPort Isolette_Data_Model__TempWstatus_impl
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_upper_alarm_tempWstatus_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_upper_alarm_tempWstatus_Send", 0);

  sb_upper_alarm_tempWstatus_write(d);
}

// FIXME: dummy implementation for unconnected outgoing port
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_lower_alarm_tempWstatus_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_lower_alarm_tempWstatus_Send", 0);
  // FIXME: dummy implementation
}

// is_empty regulator_status: In DataPort
B isolette_Isolette_operator_interface_thread_impl_seL4Nix_regulator_status_IsEmpty(STACK_FRAME_ONLY) {
  return sb_regulator_status_is_empty();
}

// receive regulator_status: In DataPort union_art_DataContent
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_regulator_status_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_regulator_status_Receive", 0);
...
B isolette_Isolette_operator_interface_thread_impl_seL4Nix_monitor_status_IsEmpty(STACK_FRAME_ONLY) {
  return sb_monitor_status_is_empty();
}

// receive monitor_status: In DataPort union_art_DataContent
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_monitor_status_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_monitor_status_Receive", 0);
...
B isolette_Isolette_operator_interface_thread_impl_seL4Nix_display_temperature_IsEmpty(STACK_FRAME_ONLY) {
  return sb_display_temperature_is_empty();
}

// receive display_temperature: In DataPort union_art_DataContent
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_display_temperature_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_display_temperature_Receive", 0);
...
B isolette_Isolette_operator_interface_thread_impl_seL4Nix_alarm_control_IsEmpty(STACK_FRAME_ONLY) {
  return sb_alarm_control_is_empty();
}

// receive alarm_control: In DataPort union_art_DataContent
Unit isolette_Isolette_operator_interface_thread_impl_seL4Nix_alarm_control_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_operator_interface_thread_impl.c", "", "isolette_Isolette_operator_interface_thread_impl_seL4Nix_alarm_control_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of operator_interface_thread_impl\n");
  ...
  isolette_Isolette_operator_interface_thread_impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  isolette_Isolette_operator_interface_thread_impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of operator_interface_thread_impl\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    isolette_Isolette_operator_interface_thread_impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
