...
package isolette.isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst
...
import isolette._
import isolette.Regulate.Manage_Heat_Source_impl_seL4Nix

object mhst extends App {

  val mhstBridge : isolette.Regulate.Manage_Heat_Source_impl_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    current_tempWstatus_port = Manage_Heat_Source_impl_seL4Nix.current_tempWstatus_Receive()

    lower_desired_temp_port = Manage_Heat_Source_impl_seL4Nix.lower_desired_temp_Receive()

    upper_desired_temp_port = Manage_Heat_Source_impl_seL4Nix.upper_desired_temp_Receive()

    regulator_mode_port = Manage_Heat_Source_impl_seL4Nix.regulator_mode_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(heat_control_port.nonEmpty) {
      Manage_Heat_Source_impl_seL4Nix.heat_control_Send(heat_control_port.get)
