...
class event_logger_thread_imp_operation_operation_process_event_logger_Test extends BridgeTestSuite[event_logger_thread_imp_operation_operation_process_event_logger_Bridge](Arch.pca_imp_Instance_operation_operation_process_event_logger) {
