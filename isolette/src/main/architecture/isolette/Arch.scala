...
object Arch {
  val isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_interface_mrit : isolette.Regulate.Manage_Regulator_Interface_impl_Bridge = {
    ...
    isolette.Regulate.Manage_Regulator_Interface_impl_Bridge(
      id = 0,
  ...
  val isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst : isolette.Regulate.Manage_Heat_Source_impl_Bridge = {
    ...
    isolette.Regulate.Manage_Heat_Source_impl_Bridge(
      id = 1,
  ...
  val isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_regulator_mode_mrmt : isolette.Regulate.Manage_Regulator_Mode_impl_Bridge = {
    ...
    isolette.Regulate.Manage_Regulator_Mode_impl_Bridge(
      id = 2,
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_mat : isolette.Monitor.Manage_Alarm_impl_Bridge = {
    ...
    isolette.Monitor.Manage_Alarm_impl_Bridge(
      id = 3,
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit : isolette.Monitor.Manage_Monitor_Interface_impl_Bridge = {
    ...
    isolette.Monitor.Manage_Monitor_Interface_impl_Bridge(
      id = 4,
  ...
  val isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt : isolette.Monitor.Manage_Monitor_Mode_impl_Bridge = {
    ...
    isolette.Monitor.Manage_Monitor_Mode_impl_Bridge(
      id = 5,
  ...
  val isolette_single_sensor_Instance_operator_interface_oip_oit : isolette.Isolette.operator_interface_thread_impl_Bridge = {
    ...
    isolette.Isolette.operator_interface_thread_impl_Bridge(
      id = 6,
  ...
  val isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat : isolette.Devices.Temperature_Sensor_impl_Bridge = {
    ...
    isolette.Devices.Temperature_Sensor_impl_Bridge(
      id = 7,
  ...
  val isolette_single_sensor_Instance_heat_source_cpi_heat_controller : isolette.Devices.Heat_Source_impl_Bridge = {
    ...
    isolette.Devices.Heat_Source_impl_Bridge(
      id = 8,
