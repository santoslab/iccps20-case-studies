...
import art._
import pca_pump._
import pca_pump.PCA_Drug_Library.{drug_library_thread_imp_operation_operation_process_drug_library => component}

// This file was auto-generated.  Do not edit

@record class drug_library_thread_imp_operation_operation_process_drug_library_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : drug_library_thread_imp_Initialization_Api = {
    ...
    drug_library_thread_imp_operation_operation_process_drug_library_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : drug_library_thread_imp_Operational_Api = {
    ...
    drug_library_thread_imp_operation_operation_process_drug_library_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    drug_library_thread_imp_operation_operation_process_drug_library_Bridge.EntryPoints(
      id,
...
object drug_library_thread_imp_operation_operation_process_drug_library_Bridge {
  ...
  @record class EntryPoints(
    drug_library_thread_imp_operation_operation_process_drug_library_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(drug_library_thread_imp_operation_operation_process_drug_library_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == Load_Drug_Library_Id){
          ...
          val Some(PCA_Types.Drug_Code_Payload(value)) = Art.getValue(Get_Drug_Record_Id)
