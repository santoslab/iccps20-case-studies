...
import art._
import pca_pump._
import pca_pump.PCA_Operation.{event_logger_thread_imp_operation_operation_process_event_logger => component}

// This file was auto-generated.  Do not edit

@record class event_logger_thread_imp_operation_operation_process_event_logger_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : event_logger_thread_imp_Initialization_Api = {
    ...
    event_logger_thread_imp_operation_operation_process_event_logger_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : event_logger_thread_imp_Operational_Api = {
    ...
    event_logger_thread_imp_operation_operation_process_event_logger_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    event_logger_thread_imp_operation_operation_process_event_logger_Bridge.EntryPoints(
      id,
...
object event_logger_thread_imp_operation_operation_process_event_logger_Bridge {
  ...
  @record class EntryPoints(
    event_logger_thread_imp_operation_operation_process_event_logger_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(event_logger_thread_imp_operation_operation_process_event_logger_BridgeId)
