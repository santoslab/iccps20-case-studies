...
class isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_mat_Test extends BridgeTestSuite[Manage_Alarm_impl_Bridge](Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_alarm_mat) {
  ...
  def put_lower_alarm_temp(value : Isolette_Data_Model.Temp_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.lower_alarm_temp_Id, Isolette_Data_Model.Temp_impl_Payload(value))
  }

  // setter for in DataPort
  def put_upper_alarm_temp(value : Isolette_Data_Model.Temp_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.upper_alarm_temp_Id, Isolette_Data_Model.Temp_impl_Payload(value))
  }
  ...
  def get_alarm_control_payload(): Option[Isolette_Data_Model.On_Off_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.alarm_control_Id).asInstanceOf[Option[Isolette_Data_Model.On_Off_Payload]]
  }

  def getComponent(): Manage_Alarm_impl_Impl = {
    return bridge.entryPoints.asInstanceOf[Manage_Alarm_impl_Bridge.EntryPoints].component
  }
}
