...
import art._
import pca_pump._
import pca_pump.PCA_Security.{Security_Thread_imp_operation_security_subsystem_security_process_security_thread => component}

// This file was auto-generated.  Do not edit

@record class Security_Thread_imp_operation_security_subsystem_security_process_security_thread_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Security_Thread_imp_Initialization_Api = {
    ...
    Security_Thread_imp_operation_security_subsystem_security_process_security_thread_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Security_Thread_imp_Operational_Api = {
    ...
    Security_Thread_imp_operation_security_subsystem_security_process_security_thread_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Security_Thread_imp_operation_security_subsystem_security_process_security_thread_Bridge.EntryPoints(
      id,
...
object Security_Thread_imp_operation_security_subsystem_security_process_security_thread_Bridge {
  ...
  @record class EntryPoints(
    Security_Thread_imp_operation_security_subsystem_security_process_security_thread_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Security_Thread_imp_operation_security_subsystem_security_process_security_thread_BridgeId)
