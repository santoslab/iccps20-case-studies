...
#include <Manage_Regulator_Interface_impl_adapter.h>
#include <string.h>
#include <camkes.h>
...
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_upper_desired_temp_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_upper_desired_temp_Send", 0);

  sb_upper_desired_temp_write(d);
}

// send lower_desired_temp: Out DataPort Isolette_Data_Model__Temp_impl
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_lower_desired_temp_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_lower_desired_temp_Send", 0);

  sb_lower_desired_temp_write(d);
}

// send displayed_temp: Out DataPort Isolette_Data_Model__Temp_impl
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_displayed_temp_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_displayed_temp_Send", 0);

  sb_displayed_temp_write(d);
}

// send regulator_status: Out DataPort Isolette_Data_Model__Status
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_regulator_status_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_regulator_status_Send", 0);

  sb_regulator_status_write(d);
}

// send interface_failure: Out DataPort Isolette_Data_Model__Failure_Flag_impl
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_interface_failure_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_interface_failure_Send", 0);

  sb_interface_failure_write(d);
}

// is_empty current_tempWstatus: In DataPort
B isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_current_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_current_tempWstatus_is_empty();
}

// receive current_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_current_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_current_tempWstatus_Receive", 0);
...
B isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_lower_desired_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_lower_desired_tempWstatus_is_empty();
}

// receive lower_desired_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_lower_desired_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_lower_desired_tempWstatus_Receive", 0);
...
B isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_upper_desired_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_upper_desired_tempWstatus_is_empty();
}

// receive upper_desired_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_upper_desired_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_upper_desired_tempWstatus_Receive", 0);
...
B isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_regulator_mode_IsEmpty(STACK_FRAME_ONLY) {
  return sb_regulator_mode_is_empty();
}

// receive regulator_mode: In DataPort union_art_DataContent
Unit isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_regulator_mode_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Regulator_Interface_impl.c", "", "isolette_Regulate_Manage_Regulator_Interface_impl_seL4Nix_regulator_mode_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of Manage_Regulator_Interface_impl\n");
  ...
  isolette_Regulate_Manage_Regulator_Interface_impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  isolette_Regulate_Manage_Regulator_Interface_impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of Manage_Regulator_Interface_impl\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    isolette_Regulate_Manage_Regulator_Interface_impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
