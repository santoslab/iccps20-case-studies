...
import art._
import pca_pump._
import pca_pump.PCA_Alarm.{Flow_Rate_Checker_imp_safety_alarm_process_flow_rate => component}

// This file was auto-generated.  Do not edit

@record class Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  Upstream_Flow_Rate: Port[PCA_Types.Flow_Rate],
  Downstream_Flow_Rate: Port[PCA_Types.Flow_Rate],
  ...
  val initialization_api : Flow_Rate_Checker_imp_Initialization_Api = {
    ...
    Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Flow_Rate_Checker_imp_Operational_Api = {
    ...
    Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_Bridge.EntryPoints(
      id,
...
object Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_Bridge {
  ...
  @record class EntryPoints(
    Flow_Rate_Checker_imp_safety_alarm_process_flow_rate_BridgeId : Art.BridgeId,
