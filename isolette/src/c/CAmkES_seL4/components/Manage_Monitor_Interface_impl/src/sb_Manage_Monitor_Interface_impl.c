...
#include <Manage_Monitor_Interface_impl_adapter.h>
#include <string.h>
#include <camkes.h>
...
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_upper_alarm_temp_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_upper_alarm_temp_Send", 0);

  sb_upper_alarm_temp_write(d);
}

// send lower_alarm_temp: Out DataPort Isolette_Data_Model__Temp_impl
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_lower_alarm_temp_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_lower_alarm_temp_Send", 0);

  sb_lower_alarm_temp_write(d);
}

// send monitor_status: Out DataPort Isolette_Data_Model__Status
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_monitor_status_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_monitor_status_Send", 0);

  sb_monitor_status_write(d);
}

// send interface_failure: Out DataPort Isolette_Data_Model__Failure_Flag_impl
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_interface_failure_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_interface_failure_Send", 0);

  sb_interface_failure_write(d);
}

// is_empty upper_alarm_tempWstatus: In DataPort
B isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_upper_alarm_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_upper_alarm_tempWstatus_is_empty();
}

// receive upper_alarm_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_upper_alarm_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_upper_alarm_tempWstatus_Receive", 0);
...
B isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_lower_alarm_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_lower_alarm_tempWstatus_is_empty();
}

// receive lower_alarm_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_lower_alarm_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_lower_alarm_tempWstatus_Receive", 0);
...
B isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_current_tempWstatus_IsEmpty(STACK_FRAME_ONLY) {
  return sb_current_tempWstatus_is_empty();
}

// receive current_tempWstatus: In DataPort union_art_DataContent
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_current_tempWstatus_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_current_tempWstatus_Receive", 0);
...
B isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_monitor_mode_IsEmpty(STACK_FRAME_ONLY) {
  return sb_monitor_mode_is_empty();
}

// receive monitor_mode: In DataPort union_art_DataContent
Unit isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_monitor_mode_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Manage_Monitor_Interface_impl.c", "", "isolette_Monitor_Manage_Monitor_Interface_impl_seL4Nix_monitor_mode_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of Manage_Monitor_Interface_impl\n");
  ...
  isolette_Monitor_Manage_Monitor_Interface_impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  isolette_Monitor_Manage_Monitor_Interface_impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of Manage_Monitor_Interface_impl\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    isolette_Monitor_Manage_Monitor_Interface_impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
