...
import art._
import pca_pump._
import pca_pump.PCA_Operation_Threads.{Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker => component}

// This file was auto-generated.  Do not edit

@record class Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Patient_Bolus_Checker_imp_Initialization_Api = {
    ...
    Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Patient_Bolus_Checker_imp_Operational_Api = {
    ...
    Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_Bridge.EntryPoints(
      id,
...
object Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_Bridge {
  ...
  @record class EntryPoints(
    Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Patient_Bolus_Checker_imp_operation_operation_process_operation_threads_patient_bolus_checker_BridgeId)
