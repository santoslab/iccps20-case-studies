...
//   mill building_control_mixed.run
//
// To run the example unit tests:
//   mill building_control_mixed.test
...
object `building_control_mixed` extends AadlTestModule {
  override def mainClass = T { Some("building_control_mixed.Demo") }
}
