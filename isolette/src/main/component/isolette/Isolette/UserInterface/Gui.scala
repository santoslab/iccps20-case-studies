...
class Gui {
  ...
  def init(_lowerDesiredTempWstatus: Isolette_Data_Model.TempWstatus_impl,
    ...
    addSpinner("Lower Desired Temperature", _lowerDesiredTempWstatus.value.native.toInt,
    ...
    addSpinner("Upper Desired Temperature", _upperDesiredTempWstatus.value.native.toInt,
    ...
    addSpinner("Lower Alarm Temperature", _lowerAlarmTempWstatus.value.native.toInt,
