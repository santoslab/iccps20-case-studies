...
package isolette.isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat
...
import isolette._
import isolette.Devices.Temperature_Sensor_impl_seL4Nix

object thermostat extends App {

  val thermostatBridge : isolette.Devices.Temperature_Sensor_impl_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    air_port = Temperature_Sensor_impl_seL4Nix.air_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(current_tempWstatus_port.nonEmpty) {
      Temperature_Sensor_impl_seL4Nix.current_tempWstatus_Send(current_tempWstatus_port.get)
