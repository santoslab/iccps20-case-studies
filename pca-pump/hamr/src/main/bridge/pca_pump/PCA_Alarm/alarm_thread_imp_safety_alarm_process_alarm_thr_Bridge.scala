...
import art._
import pca_pump._
import pca_pump.PCA_Alarm.{alarm_thread_imp_safety_alarm_process_alarm_thr => component}

// This file was auto-generated.  Do not edit

@record class alarm_thread_imp_safety_alarm_process_alarm_thr_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  Log_Fault: Port[PCA_Types.Fault_Record],
  ...
  val initialization_api : alarm_thread_imp_Initialization_Api = {
    ...
    alarm_thread_imp_safety_alarm_process_alarm_thr_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : alarm_thread_imp_Operational_Api = {
    ...
    alarm_thread_imp_safety_alarm_process_alarm_thr_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    alarm_thread_imp_safety_alarm_process_alarm_thr_Bridge.EntryPoints(
      id,
...
object alarm_thread_imp_safety_alarm_process_alarm_thr_Bridge {
  ...
  @record class EntryPoints(
    alarm_thread_imp_safety_alarm_process_alarm_thr_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(alarm_thread_imp_safety_alarm_process_alarm_thr_BridgeId)
