...
class isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_Test extends BridgeTestSuite[Manage_Monitor_Interface_impl_Bridge](Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit) {
  ...
  def put_upper_alarm_tempWstatus(value : Isolette_Data_Model.TempWstatus_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.upper_alarm_tempWstatus_Id, Isolette_Data_Model.TempWstatus_impl_Payload(value))
  }

  // setter for in DataPort
  def put_lower_alarm_tempWstatus(value : Isolette_Data_Model.TempWstatus_impl): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.lower_alarm_tempWstatus_Id, Isolette_Data_Model.TempWstatus_impl_Payload(value))
  }
  ...
  def put_monitor_mode(value : Isolette_Data_Model.Monitor_Mode.Type): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.api.monitor_mode_Id, Isolette_Data_Model.Monitor_Mode_Payload(value))
  }
  ...
  def get_upper_alarm_temp_payload(): Option[Isolette_Data_Model.Temp_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.upper_alarm_temp_Id).asInstanceOf[Option[Isolette_Data_Model.Temp_impl_Payload]]
  }
  ...
  def get_lower_alarm_temp_payload(): Option[Isolette_Data_Model.Temp_impl_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.lower_alarm_temp_Id).asInstanceOf[Option[Isolette_Data_Model.Temp_impl_Payload]]
  }
  ...
  def get_monitor_status_payload(): Option[Isolette_Data_Model.Status_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.monitor_status_Id).asInstanceOf[Option[Isolette_Data_Model.Status_Payload]]
  }
  ...
  def getComponent(): Manage_Monitor_Interface_impl_Impl = {
    return bridge.entryPoints.asInstanceOf[Manage_Monitor_Interface_impl_Bridge.EntryPoints].component
  }
}
