...
class downstream_monitor_imp_pump_fluid_downstream_mon_Test extends BridgeTestSuite[downstream_monitor_imp_pump_fluid_downstream_mon_Bridge](Arch.wrap_pca_imp_Instance_pump_fluid_downstream_mon) {
