...
import art._
import pca_pump._
import pca_pump.PCA_Operation_Threads.{Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker => component}

// This file was auto-generated.  Do not edit

@record class Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_Bridge(
  val id: Art.BridgeId,
  val name: String,
  val dispatchProtocol: DispatchPropertyProtocol,
  val dispatchTriggers: Option[ISZ[Art.PortId]],

  Prescription: Port[PCA_Types.Prescription],
  VTBI: Port[PCA_Types.Drug_Volume],
  Square_Bolus_Rate: Port[PCA_Types.Flow_Rate],
  Patient_Bolus_Rate: Port[PCA_Types.Flow_Rate],
  Basal_Rate: Port[PCA_Types.Flow_Rate],
  Minimum_Time_Between_Bolus: Port[ICE_Types.Minute],
  Max_Drug_Per_Hour: Port[PCA_Types.Drug_Volume],
  Get_Drug_Record: Port[PCA_Types.Drug_Code],
  The_Drug_Record: Port[PCA_Types.Drug_Record],
  ...
  val initialization_api : Prescription_Checker_imp_Initialization_Api = {
    ...
    Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Prescription_Checker_imp_Operational_Api = {
    ...
    Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_Bridge.EntryPoints(
      id,
...
object Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_Bridge {
  ...
  @record class EntryPoints(
    Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Prescription_Checker_imp_operation_operation_process_operation_threads_prescription_checker_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == The_Drug_Record_Id){
          val Some(PCA_Types.Drug_Record_Payload(value)) = Art.getValue(The_Drug_Record_Id)
