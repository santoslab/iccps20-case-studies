...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/slang_libraries/BuildingControlDemo_i_Instance_tcp_tempSensor"
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --cmake-includes "+${SCRIPT_HOME}/settings_BuildingControlDemo_i_Instance_tcp_tempSensor.cmake" \
  --forward "art.ArtNative=building_control_gen_mixed.BuildingControlDemo_i_Instance_tcp_tempSensor.tempSensor" \
  --stack-size "110592" \
  --stable-type-id \
  --exts "${SCRIPT_HOME}/../src/c/ext-c/ext.c${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/ext.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_tempSensor/TempSensor_i_adapter.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_tempSensor/TempSensor_i_adapter.c" \
  --lib-only \
  --verbose

OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/slang_libraries/BuildingControlDemo_i_Instance_tcp_tempControl"
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --cmake-includes "+${SCRIPT_HOME}/settings_BuildingControlDemo_i_Instance_tcp_tempControl.cmake" \
  --forward "art.ArtNative=building_control_gen_mixed.BuildingControlDemo_i_Instance_tcp_tempControl.tempControl" \
  --stack-size "110592" \
  --stable-type-id \
  --exts "${SCRIPT_HOME}/../src/c/ext-c/ext.c${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/ext.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_tempControl/TempControl_i_adapter.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_tempControl/TempControl_i_adapter.c" \
  --lib-only \
  --verbose

OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/slang_libraries/BuildingControlDemo_i_Instance_tcp_fan"
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --sequence "MS[Z,art.Bridge]=1;MS[Z,MOption[art.Bridge]]=1;IS[Z,art.UPort]=2;IS[Z,art.UConnection]=1" \
  --constants "art.Art.maxComponents=1;art.Art.maxPorts=2" \
  --cmake-includes "+${SCRIPT_HOME}/settings_BuildingControlDemo_i_Instance_tcp_fan.cmake" \
  --forward "art.ArtNative=building_control_gen_mixed.BuildingControlDemo_i_Instance_tcp_fan.fan" \
  --stack-size "110592" \
  --stable-type-id \
  --exts "${SCRIPT_HOME}/../src/c/ext-c/ext.c${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/ext.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_fan/Fan_i_adapter.h${PATH_SEP}${SCRIPT_HOME}/../src/c/ext-c/adapters/BuildingControlDemo_i_Instance_tcp_fan/Fan_i_adapter.c" \
  --lib-only \
  --verbose
