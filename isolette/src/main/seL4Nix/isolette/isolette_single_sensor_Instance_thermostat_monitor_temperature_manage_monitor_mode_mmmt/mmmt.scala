...
package isolette.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt
...
import isolette._
import isolette.Monitor.Manage_Monitor_Mode_impl_seL4Nix

object mmmt extends App {

  val mmmtBridge : isolette.Monitor.Manage_Monitor_Mode_impl_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    current_tempWstatus_port = Manage_Monitor_Mode_impl_seL4Nix.current_tempWstatus_Receive()

    interface_failure_port = Manage_Monitor_Mode_impl_seL4Nix.interface_failure_Receive()

    internal_failure_port = Manage_Monitor_Mode_impl_seL4Nix.internal_failure_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(monitor_mode_port.nonEmpty) {
      Manage_Monitor_Mode_impl_seL4Nix.monitor_mode_Send(monitor_mode_port.get)
