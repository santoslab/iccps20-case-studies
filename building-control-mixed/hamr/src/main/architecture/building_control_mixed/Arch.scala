...
object Arch {
  val BuildingControlDemo_i_Instance_tcp_tempSensor : building_control_mixed.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge = {
    ...
    building_control_mixed.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge(
      id = 0,
  ...
  val BuildingControlDemo_i_Instance_tcp_tempControl : building_control_mixed.BuildingControl.TempControl_i_tcp_tempControl_Bridge = {
  ...
  val BuildingControlDemo_i_Instance_tcp_fan : building_control_mixed.BuildingControl.Fan_i_tcp_fan_Bridge = {
